...
class SymbolizeRoadLayer(TDGAlgorithm):
    ...
    def help(self):
        html = markdown2.markdown_path(os.path.join(self.helpPath,'Symbolize Road Layer.md'))
        return True, html
    ...
    def defineCharacteristics(self):
        ...
        self.name = 'Symbolize road layer'
    ...
    def processAlgorithm(self, progress):
        ...
        inLayer.loadNamedStyle(
            os.path.join(self.stylePath, 'base_roads.qml')
        )
        inLayer.triggerRepaint()
